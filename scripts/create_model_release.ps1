...
Write-Host "1. Open GitHub repo Releases."
Write-Host "2. Create or edit release tag: model-artifacts."
Write-Host "3. Upload/replace asset: $Output."
Write-Host "4. Run GitHub Actions workflow_dispatch once to smoke test Telegram."
